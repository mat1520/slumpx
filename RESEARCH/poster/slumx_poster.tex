...
\definecolor{GrayBlueBackground}{HTML}{F0F4F8}
\definecolor{DarkCharcoal}{HTML}{2D3748}
\definecolor{CorporateBlue}{HTML}{3182CE}
\definecolor{TealAccent}{HTML}{38B2AC}
\definecolor{BurntOrange}{HTML}{DD6B20}
\definecolor{LightGray}{HTML}{EDF2F7}
\definecolor{HighRisk}{HTML}{F56565}
\definecolor{MediumRisk}{HTML}{ED8936}
\definecolor{LowRisk}{HTML}{48BB78}

% aplicar colores profesionales
\definecolorstyle{ProfessionalStyle}{
    \definecolor{colorOne}{named}{CorporateBlue}
    \definecolor{colorTwo}{named}{TealAccent}
    \definecolor{colorThree}{named}{BurntOrange}
}{
    % background
    \colorlet{backgroundcolor}{GrayBlueBackground}
    \colorlet{framecolor}{CorporateBlue}
    % title colors
    \colorlet{titlefgcolor}{DarkCharcoal}
    \colorlet{titlebgcolor}{GrayBlueBackground}
    % block colors
    \colorlet{blocktitlebgcolor}{CorporateBlue}
    \colorlet{blocktitlefgcolor}{white}
    \colorlet{blockbodybgcolor}{white}
    \colorlet{blockbodyfgcolor}{DarkCharcoal}
    % innerblock colors
    \colorlet{innerblocktitlebgcolor}{TealAccent!15}
    \colorlet{innerblocktitlefgcolor}{DarkCharcoal}
    \colorlet{innerblockbodybgcolor}{LightGray}
    \colorlet{innerblockbodyfgcolor}{DarkCharcoal}
    % note colors
    \colorlet{notefgcolor}{DarkCharcoal}
    \colorlet{notebgcolor}{BurntOrange!15}
    \colorlet{noteframecolor}{BurntOrange}
}

% aplicar tema
\usecolorstyle{ProfessionalStyle}
\usebackgroundstyle{Default}
\usetitlestyle{Default}
\useblockstyle{Default}

% titulo y autores
\title{\parbox{0.95\linewidth}{\centering \Large \textbf{Analysis of IoT Botnet Structure and Behavior: A Study Based on the Hitori (SlumX) Variant}}}
\author{\Large Ariel Matias Melo Pazmiño \quad | \quad Universidad Internacional del Ecuador - Facultad de Ciencias Técnicas}
\institute{}

% logos con mejor posicionamiento
\titlegraphic{
    \includegraphics[width=6cm]{university_logo.png}
    \hspace{11cm}
    \includegraphics[height=2.5cm]{faculty_logo.png}
}
...
\vspace{0.3em}
\noindent\colorbox{TealAccent!20}{\parbox{0.95\linewidth}{
...
\textit{\small IEEE References: [1] IoT Security Analysis, [2] Botnet Detection Methods}
}

\block{Research Objectives}{
\textbf{\large General Objective}
\begin{itemize}
    \item Conduct in-depth technical analysis of Hitori (SlumX) variant to understand modern IoT botnet threats
\end{itemize}

\vspace{0.3em}
\textbf{\large Specific Objectives}
\begin{itemize}
...
\vspace{0.2em}
\textit{\small Ref. [3] Botnet Architecture Analysis}
}

\block{Methodology}{
\textbf{\large Static Code Analysis Framework}
...
\vspace{0.2em}
\colorbox{BurntOrange!15}{\parbox{0.95\linewidth}{
\textbf{Limitations:} Static analysis cannot capture all runtime behaviors; no testing on actual IoT devices; temporal snapshot of evolving malware.
}}

\vspace{0.2em}
\textit{\small Ref. [4] Static Analysis Methods, [5] Malware Reverse Engineering}
}
...
\vspace{0.5em}
\includegraphics[width=6cm]{QR_research.png}
\end{center}
}
