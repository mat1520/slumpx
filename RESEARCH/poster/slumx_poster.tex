...
\begin{columns}
    ...
    \block{\textcolor{AccentOrange}{9.} Attack Vector Complexity}{
        ...
        \begin{minipage}{0.95\linewidth}
            \normalsize
            The botnet implements a versatile range of DDoS capabilities. Our code analysis reveals that HTTP flooding represents the most sophisticated vector (95 LOC), requiring the construction of valid headers to bypass standard filters. In contrast, UDP and TCP floods rely on direct raw socket manipulation to generate high-volume volumetric traffic [3].
        \end{minipage}
    }
    ...
    \block{\textcolor{AccentOrange}{10.} Key Findings \& Conclusions}{
        ...
        \begin{itemize}\setlength\itemsep{0.6em}
            \item \textbf{\color{AccentCyan}Multiple Architectures:} Extensive cross-platform support covering twelve distinct processor architectures, including MIPS, ARM, and x86, maximizing the potential infection pool.
            \item \textbf{\color{AccentPurple}Advanced Evasion:} Implementation of IoT-centric defensive mechanisms, including anti-debugging routines and dynamic process masquerading.
            \item \textbf{\color{AccentOrange}Targeted Exploitation:} A strategic shift towards precision attacks using manufacturer-specific vulnerabilities, moving away from indiscriminate mass-scanning approaches.
