...
\begin{columns}
    ...
    \block{\textcolor{AccentOrange}{9.} Attack Vector Complexity}{
        ...
        \begin{minipage}{0.95\linewidth}
            \normalsize
            SlumX allows for multiple DDoS attack vectors. Analysis shows that HTTP Floods have the highest complexity (95 LOC) because they need valid HTTP headers to avoid simple filtering, while UDP and TCP floods manipulate raw sockets to generate massive traffic [3].
        \end{minipage}
    }
    ...
    \block{\textcolor{AccentOrange}{10.} Key Findings \& Conclusions}{
        ...
        \begin{itemize}\setlength\itemsep{0.6em}
            \item \textbf{\color{AccentCyan}Multiple Architectures:} Support for twelve processor types (MIPS, ARM, x86, etc.) provides broad attack capabilities.
            \item \textbf{\color{AccentPurple}Advanced Evasion:} Anti-debugging and process name spoofing techniques specific to IoT environments.
            \item \textbf{\color{AccentOrange}Targeted Exploitation:} Manufacturer-specific exploits suggest targeted attacks rather than spray-and-pray campaigns.
